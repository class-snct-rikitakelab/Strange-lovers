...
void seesaw_1_factory_init(){
	...
	use_controller.target_curvature_controller_weight =0.85; //曲率制御の重み付け
	use_controller.target_light_controller_weight =0.15;	//輝度制御の重み付け
	...
	*/
	...
	target_values.target_brightness = 0.45; //目標輝度
	target_values.target_curvature = 0.0; //目標曲率 [1/mm]
	target_values.target_speed = 80;  //目標速度 [mm/s]
